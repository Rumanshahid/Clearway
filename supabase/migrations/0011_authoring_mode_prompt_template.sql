-- Adds authoring-mode branching (doctor vs. patient) and universal
-- human-voice rules to the letter prompt template. Deactivates the current
-- active template and inserts this as the new active version.
