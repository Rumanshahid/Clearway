    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "nav_link_platform", label: "\"Platform\" link label", default: "Platform" },
    ...
    sections: [
      {
        title: "Hero",
        fields: [
          { key: "hero_tag", label: "Eyebrow tag", default: "AI for Practice Operations" },
          { key: "hero_headline", label: "Headline", type: "textarea", default: "Stop losing hours to paperwork that isn't patient care." },
          {
            key: "hero_subheadline",
            label: "Subheadline",
            type: "textarea",
            default:
              "asaanbil.com drafts prior authorization letters and claim appeals citing the exact criteria each payer checks for, runs your booking calendar end to end, and keeps your whole front desk working from one dashboard — not four different logins.",
          },
          ...
          { key: "hero_meta_2", label: "Trust bullet 2", default: "Human reviews every draft" },
      ...
      },
      {
        ...
        visibilityKey: "section_platform",
        fields: [
          { key: "platform_eyebrow", label: "Eyebrow", default: "The Platform" },
          { key: "platform_h2", label: "Headline", default: "One system for the paperwork that isn't patient care." },
          {
            key: "platform_intro",
            label: "Intro paragraph",
            type: "textarea",
            default: "asaanbil.com started with prior authorization. It now runs the rest of your front office too — same login, same dashboard.",
          },
          { key: "platform1_name", label: "Card 1 name", default: "Prior Authorization" },
          {
            key: "platform1_desc",
            label: "Card 1 description",
            type: "textarea",
            default: "Draft letters citing the exact medical-necessity criteria each payer checks for, with missing documentation flagged before you submit.",
          },
          { key: "platform2_name", label: "Card 2 name", default: "Claims & Appeals" },
          {
            key: "platform2_desc",
            label: "Card 2 description",
            type: "textarea",
            default: "Log denials, auto-fill the form straight from an uploaded EOB, and get an AI-drafted appeal letter with the deadline already on the calendar.",
          },
          { key: "platform3_name", label: "Card 3 name", default: "Scheduling & Booking" },
          {
            key: "platform3_desc",
            label: "Card 3 description",
            type: "textarea",
            default: "Patients book their own slot from your public profile, get reminders automatically, and a thank-you note goes out after every visit — no front-desk phone tag.",
          },
          { key: "platform4_name", label: "Card 4 name", default: "Team & Patients" },
          {
            key: "platform4_desc",
            label: "Card 4 description",
            type: "textarea",
            default: "Invite staff with role-based access, track your patient roster and eligibility checks, and run it all from one dashboard you can rearrange to fit how your practice works.",
          },
        ],
      },
      {
        title: "How It Works",
        fields: [
          { key: "how_eyebrow", label: "Eyebrow", default: "Prior Authorization, Step by Step" },
      ...
      },
      {
        ...
        fields: [
          ...
          { key: "cmp3_before", label: "Slide 3 — before", type: "textarea", default: "A denied claim sat in a drawer until someone remembered the deadline — asaanbil.com now " },
          { key: "cmp3_em", label: "Slide 3 — emphasized phrase", default: "tracks every appeal deadline automatically" },
          { key: "cmp3_after", label: "Slide 3 — after", default: "." },
          { key: "cmp4_before", label: "Slide 4 — before", type: "textarea", default: "New patients played phone tag for days to get on the calendar — asaanbil.com now " },
          { key: "cmp4_em", label: "Slide 4 — emphasized phrase", default: "lets them book their own slot in under a minute" },
          { key: "cmp4_after", label: "Slide 4 — after", default: "." },
        ],
      },
      {
      ...
      },
      {
        title: "Final CTA",
        fields: [
          { key: "cta_final_headline", label: "Headline", default: "Bring us your busiest week." },
          { key: "cta_final_copy", label: "Copy", default: "Prior auth, claims, scheduling — we'll show you what changes before you commit to anything." },
