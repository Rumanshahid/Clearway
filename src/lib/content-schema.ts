      ...
      },
      {
        ...
        fields: [
          ...
          { key: "insurers_h2", label: "Headline", default: "We only cover what we can get right." },
          {
            ...
            label: "Intro paragraph",
            type: "textarea",
            default: "Two insurers with real public criteria now. More — once a pilot gives us genuine denial data to work from, not guesswork.",
          },
          ...
          { key: "insurer3_desc", label: "Card 3 description", type: "textarea", default: "UHC's criteria (InterQual) are proprietary. Coverage is being built from real client submission data — priority access if UHC is your top payer." },
          { key: "insurer4_name", label: "Card 4 name", default: "BCBS / Humana" },
          { key: "insurer4_desc", label: "Card 4 description", type: "textarea", default: "BCBS runs 34 independent state plans; Humana relies on MCG criteria. Tell us your state and payer mix — we'll scope the right one first." },
        ],
      },
      {
