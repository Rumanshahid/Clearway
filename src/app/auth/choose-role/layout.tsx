...
// Mirrors (auth)/layout.tsx's chrome exactly -- this route lives under the
// literal /auth/ segment (not the (auth) route group) since it needs its
// own guard logic per sub-page, but should look identical to sign-in/sign-up.
