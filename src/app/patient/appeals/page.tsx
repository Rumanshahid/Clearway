...
import PatientAppealRequestRow from "./PatientAppealRequestRow";
    ...
    <div className="max-w-[1300px] mx-auto py-8 px-5">
      ...
      {submitted && !error && (
        <div className="mb-6 text-[13px] rounded-lg px-3 py-2" style={{ background: "var(--success-bg)", color: "var(--success-green)" }}>
          Appeal submitted — see it in the table below.
        </div>
      )}
      {error && (
            ...
            <table className="w-full text-[13.5px]">
              <thead>
                <tr className="text-left text-gray-400 text-[11px] uppercase tracking-wide" style={{ borderBottom: "1px solid var(--gray-200)" }}>
                  ...
                  <th className="px-5 py-3 font-semibold">Denial reason</th>
                ...
                {requests && requests.length > 0 ? (
                  ...
                  <tr>
                    <td className="px-5 py-10 text-center text-gray-400" colSpan={6}>
                      No appeals yet. Click &quot;+ New appeal&quot; to submit one.
                    </td>
                  </tr>
                )}
              </tbody>
