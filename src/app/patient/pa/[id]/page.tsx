...
export default async function PatientPaRequestDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { data: request } = await admin
    ...
    .select("id, doctor_profile_id, procedure_description, notes, status, created_at, letter_content, risk_flags, suggestions")
    .eq("id", id)
  ...
  return (
    <div className="max-w-[700px] mx-auto py-8 px-5">
      <Link href="/patient/pa" className="text-[13px] text-gray-400 mb-3 inline-block">← Back to requests</Link>
