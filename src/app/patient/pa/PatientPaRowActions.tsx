...
import { deletePatientPaRequestAction } from "./actions";

export default function PatientPaRowActions({ requestId, hasLetter }: { requestId: string; hasLetter: boolean }) {
  return (
    <div className="flex items-center gap-3">
      {hasLetter ? (
        <a
          href={`/api/patient/pa/${requestId}/pdf`}
          target="_blank"
      ...
      <form
        action={deletePatientPaRequestAction}
        onSubmit={(e) => {
          if (!confirm("Delete this request and its letter? This can't be undone.")) {
            e.preventDefault();
          }
        }}
      >
